...
public class MarketSystemProxyBridge implements MarketSystemBridge {
    ...
    public void removeNewProduct(String userName, String shopName, String productName) {
        nullCheck();
        realBridge.removeNewProduct(userName, shopName, productName);
    }
    ...
    public Collection<ProductIntr> search(String userName, String productName) {
        nullCheck();
        return realBridge.search(userName, productName);
    }

    @Override
    public Collection<PurchaseIntr> getShopPurchaseHistory(String shopName) {
        nullCheck();
        return realBridge.getShopPurchaseHistory(shopName);
    }
    ...
    public void changeManagerPermissions(String manager, String permission) {
        nullCheck();
        realBridge.changeManagerPermissions(manager, permission);
    }
